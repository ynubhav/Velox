...
export default function SignUpForm() {
  ...
  return (
    <div className="flex items-start justify-center text-white py-10 px-6 rounded-lg ">
        ...
        <form onSubmit={handleSubmit} className="px-6 py-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span className="text-sm text-white font-medium">Sign Up with GitHub</span>
            </button>
          </div>
          ...
          <p className="text-xs text-slate-500">
            ...
            <Link href="/docs/Velox-Customer-Agreement" className="text-blue-600 underline">
              Velox Customer Agreement
            </Link>
            .
          </p>
          ...
          <div>
            <button
              type="submit"
              className="w-full mt-2 py-3 rounded-md bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-all focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-blue-300 hover:scale-102 hover:cursor-pointer"
            >
              Sign Up
            </button>
          </div>
